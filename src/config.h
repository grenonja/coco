...
const uint8_t SENSOR_TRIGGER_THRESHOLD = 10;  // The proximity value level that triggers a lid opening. (lower=brighter, higher=darker)

const int LID_START_POSITION = 90;
const int LID_END_POSITION = 27;
